...
<template>
  <div class="container" app>
    <div v-for="pokemon in filteredPokemons" :style="{ backgroundColor: colors[pokemon.types[0]] || 'rgb(255, 146, 146)'}" :key="pokemon.id" class="pokemon container-pokemon" @click="openModal(pokemon)">
